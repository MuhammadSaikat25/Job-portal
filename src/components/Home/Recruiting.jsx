...
const Recruiting = () => {
  return (
    <div className="max-w-7xl mx-auto w-full bg-slate-200 p-10 mb-10 mt-14 rounded-md flex items-center gap-10 flex-col-reverse lg:flex-row lg:justify-between">
